...
class SettingsPageState extends State<SettingsPage> {
  ...
  void readLocal() {
    setState(() {
      ...
      username = settingProvider.getPref(FirestoreConstants.nickname) ?? "";
  ...
  void handleUpdateData() {
    ...
    settingProvider
        .updateDataFirestore(FirestoreConstants.pathUserCollection,
            AppPref.useruid, updateInfo.toJson())
        .then((data) async {
      await settingProvider.setPref(FirestoreConstants.nickname, username);
